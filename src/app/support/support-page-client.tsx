    ...
    <div className="space-y-2">
      {FAQ_ITEMS.map((item, i) => {
        ...
        return (
          <div
            key={item.q}
            className="overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-sm transition-all duration-200"
          >
            <button
              type="button"
              className="flex w-full min-h-[44px] items-center justify-between gap-3 px-4 py-3 text-left text-sm font-semibold text-neutral-900 md:px-5 md:py-4 md:text-base"
            ...
            {isOpen ? (
              <div className="border-t border-neutral-100 px-4 py-3 text-sm leading-relaxed text-neutral-600 md:px-5 md:py-4">
                {item.a}
              </div>
            ) : null}
          </div>
...
export function SupportContactForm() {
  ...
  return (
    <form
      ...
      className="space-y-4 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm md:p-8"
    >
      ...
      <label className="flex flex-col gap-2">
        <span className="text-sm font-semibold text-neutral-800">Naam</span>
        <input
          name="name"
          value={name}
      ...
      <label className="flex flex-col gap-2">
        <span className="text-sm font-semibold text-neutral-800">E-mail</span>
        <input
          name="email"
          type="email"
          value={email}
      ...
      <label className="flex flex-col gap-2">
        <span className="text-sm font-semibold text-neutral-800">Bericht</span>
        <textarea
          name="message"
          value={message}
      ...
      <button
        ...
        className="inline-flex min-h-[44px] w-full items-center justify-center rounded-lg bg-black px-6 text-sm font-semibold text-white transition-all duration-200 hover:bg-neutral-800 disabled:opacity-60 sm:w-auto"
      >
