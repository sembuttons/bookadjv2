...
export function NederlandCoverageMap() {
  return (
    <div className="mx-auto max-w-2xl rounded-3xl border border-green-200 bg-white p-6 shadow-sm sm:p-10">
      <svg
        viewBox="0 0 100 100"
      ...
      <p className="mt-6 text-center text-sm font-semibold text-green-600 sm:text-base">
