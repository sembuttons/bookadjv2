...
export default function StedenPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-neutral-900">
      ...
      <header className="border-b border-neutral-200 bg-gradient-to-b from-emerald-50/80 to-white px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-balance text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl md:text-5xl">
