...
export default function GeschillenPage() {
  return (
    <MarketingPageShell maxWidth="prose">
      ...
      <section className="mt-12 space-y-6 text-gray-400">
        <h2 className="text-xl font-bold text-white">
          Stappenplan
        </h2>

        <div className="rounded-xl border border-gray-800 bg-[#111827] p-5 shadow-sm">
          <p className="text-sm font-bold text-green-400">Stap 1</p>
        ...
        <div className="rounded-xl border border-gray-800 bg-[#111827] p-5 shadow-sm">
          <p className="text-sm font-bold text-green-400">Stap 2</p>
          <h3 className="mt-1 font-semibold text-white">
        ...
        <div className="rounded-xl border border-gray-800 bg-[#111827] p-5 shadow-sm">
          <p className="text-sm font-bold text-green-400">Stap 3</p>
          <h3 className="mt-1 font-semibold text-white">
