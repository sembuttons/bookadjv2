    ...
    <MarketingPageShell maxWidth="prose">
      ...
      <section className="mt-12 pt-10">
        ...
        <div className="mt-4 space-y-4 text-slate-600">
          <p>
            Betalingen verlopen via <strong className="text-slate-900">Stripe</strong>. Je kunt onder meer
          ...
          <p>
            ...
            boeking heeft <strong className="text-slate-900">geaccepteerd</strong>. Zo betaal je niet voor
      ...
      <section className="mt-12 pt-10">
        ...
        <p className="mt-4 text-slate-600">
          Onderstaande termijnen zijn een <strong className="text-slate-900">richtlijn</strong> ten
          opzichte van de datum van je evenement. Afwijkingen zijn mogelijk als
          dat in je boeking of in de voorwaarden staat.
        </p>
        <ul className="mt-6 space-y-4 rounded-xl border border-green-200 bg-[#f0fdf4] p-5 text-slate-700">
          <li>
            <strong className="text-slate-900">Meer dan 30 dagen</strong> voor
          ...
          <li>
            <strong className="text-slate-900">Minder dan 14 dagen</strong>{" "}
