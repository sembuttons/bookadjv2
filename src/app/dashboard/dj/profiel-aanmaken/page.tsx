    ...
    return (
      <div className="mx-auto max-w-2xl overflow-hidden rounded-2xl border border-green-200 bg-white shadow-sm">
        <div className="bg-[#f0fdf4] px-6 py-10 text-center sm:px-10">
          ...
          <p className="mt-3 text-2xl font-bold tracking-tight text-green-400">
            Je profiel is ingediend ter verificatie
          </p>
          <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-green-400/80">
      ...
      >
          ...
          <div className="mt-6 flex flex-col gap-6">
            <div className={fieldStack}>
              <span className={labelCls}>
                Artiestennaam <span className="text-red-400">*</span>
              </span>
              <input
                type="text"
                value={stageName}
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 flex flex-col gap-6">
            <div className={fieldStack}>
              <span className={labelCls}>
                Uurtarief (€ per uur) <span className="text-red-400">*</span>
              </span>
              <input
                type="number"
                min={1}
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 flex flex-col gap-6">
            <div className={fieldStack}>
              <span className={labelCls}>
                BTW-nummer <span className="text-red-400">*</span>
              </span>
              <input
                type="text"
                value={vatNumber}
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full rounded-xl bg-green-500 py-3.5 text-sm font-bold text-black hover:bg-green-400 disabled:opacity-50 sm:w-auto sm:px-10"
        >
