...
export default function AlsDjAnnuleertPage() {
  return (
    <MarketingPageShell maxWidth="prose">
      ...
      <div className="mt-8 rounded-xl border border-green-200 bg-[#f0fdf4] px-5 py-4 text-slate-700">
        <p className="font-semibold text-slate-900">Samengevat</p>
      ...
      <section className="mt-12 space-y-4 text-slate-600">
